...
export async function POST(request: NextRequest) {
  try {
    ...
    const comprehensiveWinningNumbers = getAllTwoDigitEndings(results)
    ...
    // STEP 3: Process lottery draw using the new function
    ...
    return NextResponse.json({
      success: true,
      message: "Lottery drawn and bets processed successfully.",
      session: {
        id: session.id,
