...
BEGIN
    ...
    FOR i IN 1..20 LOOP
        ...
        session_time := current_time - (i || ' minutes')::INTERVAL;
        
        -- Extract date parts for session number
        year_part := EXTRACT(YEAR FROM session_time)::INT;
        month_part := EXTRACT(MONTH FROM session_time)::INT;
        day_part := EXTRACT(DAY FROM session_time)::INT;
        hour_part := EXTRACT(HOUR FROM session_time)::INT;
        minute_part := EXTRACT(MINUTE FROM session_time)::INT;
        ...
        session_number_val := (
            ...
            LPAD(hour_part::TEXT, 2, '0') ||
            LPAD(minute_part::TEXT, 2, '0')
        )::BIGINT;
    ...
    FOR i IN 1..20 LOOP
        ...
        session_time := current_time - (i * 3 || ' minutes')::INTERVAL;
    ...
    session_time := current_time + INTERVAL '1 minute';
    ...
    session_time := current_time + INTERVAL '3 minutes';
