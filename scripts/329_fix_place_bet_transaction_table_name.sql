-- Fix the place_bet_transaction function to use user_bets instead of game_bets
...
BEGIN
    ...
    -- Create bet record in user_bets table (FIXED: changed from game_bets to user_bets)
    INSERT INTO user_bets (
        user_id, session_id, bet_type, numbers, amount, potential_win, status, created_at, updated_at
    ) VALUES (
        p_user_id, p_session_id, p_bet_type, p_numbers, p_total_cost, p_potential_win, 'pending', NOW(), NOW()
