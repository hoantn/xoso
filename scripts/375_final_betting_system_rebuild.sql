-- =====================================================
-- FINAL BETTING SYSTEM REBUILD - NO ERRORS
-- This script will completely rebuild the betting system
-- =====================================================
...
BEGIN
    ...
    -- Insert transaction record with correct type 'purchase'
...
BEGIN
    ...
    RAISE NOTICE '=== BETTING SYSTEM FINAL REBUILD COMPLETE ===';
    ...
    RAISE NOTICE '  🔄 Transaction types: "purchase" (bet), "bet_won" (win)';
    RAISE NOTICE '';
